; Listing generated by Microsoft (R) Optimizing Compiler Version 19.51.36257.0 

	TITLE	D:\Documentos\~Mods\Postal\1\Traducción Español Latino (WIP)\Postal_Spanish_Localization\Build\Orange\Release\str.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File D:\Documentos\~Mods\Postal\1\Traducción Español Latino (WIP)\Postal_Spanish_Localization\RSPiX\Src\ORANGE\str\str.cpp
...
; 412  : 	while (*pszStr1 != '\0' && *pszStr2 != '\0' && sRes == 0 && count--)
	...
	mov	esi, DWORD PTR _pszStr1$[ebp]
	push	edi
	mov	edi, DWORD PTR _pszStr2$[ebp]
	cmp	BYTE PTR [esi], cl
