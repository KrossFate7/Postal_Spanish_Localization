...
#if ENGLISH_LOCALE
	extern char g_pszEditorDisabled[]			=	"El editor no esta disponible en esta version demo.";
	extern char g_pszMultiplayerDisabled[]		=	"El multijugador no esta disponible en esta version demo.";
	extern char g_pszBuy[]							=	"Puedes ordenar la version completa del juego en"
																"\n\n"
																"         www.gopostal.com"
																"\n\n"
																"Sabes que la quieres... que estas esperando?!";
#elif LOCALE == GERMAN
#elif LOCALE == FRENCH
#endif
...
////////////////////////////////////////////////////////////////////////////////
	...
	extern char g_pszMainMenu_Start[]							= "JUGAR";
	extern char g_pszMainMenu_Options[]							= "OPCIONES";
	extern char g_pszMainMenu_Editor[]							= "EDITOR";
	extern char g_pszMainMenu_Buy[]								= "INFO DE COMPRA";
	extern char g_pszMainMenu_Exit[]								= "SALIR";

	extern char g_pszVerifyExitMenu_Title[]					= "QUIERES SALIR?";
	extern char g_pszVerifyExitMenu_Yes[]						= "SI";
	extern char g_pszVerifyExitMenu_No[]						= "NO";

	extern char g_pszVerifyQuitMenu_Title[]					= "DESEAS ABANDONAR?";
	extern char g_pszVerifyQuitMenu_Yes[]						= "SI";
	extern char g_pszVerifyQuitMenu_No[]						= "NO";

	extern char g_pszGameMenu_Title[]							= "JUEGO";
	extern char g_pszGameMenu_Continue[]						= "CONTINUAR";
	extern char g_pszGameMenu_Save[]								= "GUARDAR";
	extern char g_pszGameMenu_Options[]							= "OPCIONES";
	extern char g_pszGameMenu_Quit[]								= "ABANDONAR";

	extern char g_pszEditorMenu_Title[]							= "EDITOR";
	extern char g_pszEditorMenu_Continue[]						= "CONTINUAR";
	extern char g_pszEditorMenu_Options[]						= "OPCIONES";
	extern char g_pszEditorMenu_Quit[]							= "SALIR";

	extern char g_pszOptionsMenu_Title[]						= "OPCIONES";
	...
	extern char g_pszOptionsMenu_Multiplayer[]				= "MULTIJUGADOR";
	extern char g_pszOptionsMenu_Performance[]				= "OPTIMIZACION";
	extern char g_pszOptionsMenu_Difficulty[]					= "DIFICULTAD";
	extern char g_pszOptionsMenu_Crosshair[]					= "MIRA";
#ifdef KID_FRIENDLY_OPTION
	extern char g_pszOptionsMenu_KidMode[]						= "MODO INFANTIL";
#endif
	extern char g_pszDifficultyMenu_Title[]					= "DIFICULTAD";
	extern char g_pszDifficultyMenu_SetDifficulty[]			= "DEFINIR";

	extern char g_pszOrganMenu_Title[]							= "PRUEBA DE SONIDO";
	extern char g_pszOrganMenu_SpecialKeysHeading[]			= "TECLAS ESPECIALES";
	extern char g_pszOrganMenu_NumericKeysFunction[]		= "  0 a 9 - REPRODUCIR SONIDO";
	extern char g_pszOrganMenu_AlphaKeysFunction[]			= "  A a Z - REPRODUCIR SONIDO";
	extern char g_pszOrganMenu_TabKeyFunction[]				= "  TAB - SIGUIENTE GRUPO DE SONIDOS";
	extern char g_pszOrganMenu_Exit[]							= "SALIR";

	extern char g_pszAudioMenu_Title[]							= "AUDIO";
	extern char g_pszAudioMenu_Mixer[]							= "MEZCLADOR";
	extern char g_pszAudioMenu_SoundTest[]						= "PRUEBA DE SONIDO";
	extern char g_pszAudioMenu_Language[]						= "IDIOMA";
	extern char g_pszAudioMenu_PainFrequency[]					= "FREQ. DE DOLOR";
	extern char g_pszAudioMenu_English[]						= "Ingles";
	extern char g_pszAudioMenu_Japanese[]						= "Japones";

	extern char g_pszVideoMenu_Title[]							= "VIDEO";
	extern char g_pszVideoMenu_Gamma[]							= "GAMMA";

	extern char g_pszControlsMenu_Title[]						= "CONTROLES";
	extern char g_pszControlsMenu_KeyboardSetup[]			= "CONFIGURAR TECLADO";
	extern char g_pszControlsMenu_MouseSetup[]				= "CONFIGURAR MOUSE";
	extern char g_pszControlsMenu_JoystickSetup[]			= "CONFIGURAR CONTROL";
	extern char g_pszControlsMenu_TurningSpeeds[]			= "VELOCIDADES DE GIRO";
	extern char g_pszControlsMenu_UseMouse[]					= "USAR MOUSE";
	extern char g_pszControlsMenu_ClassicMouse[]			= "MOUSE CLASICO";	
	extern char g_pszControlsMenu_HorizMouseSensitivity[]	= "SENS. MOUSE HORIZ.";
	extern char g_pszControlsMenu_VertMouseSensitivity[]	= "SENS. MOUSE VERT.";

	extern char g_pszKeyboardSetupMenu_Title[]				= "CONFIGURAR TECLADO";

	extern char g_pszMouseSetupMenu_Title[]					= "CONFIGURAR MOUSE";

	extern char g_pszJoystickSetupMenu_Title[]				= "CONFIGURAR CONTROL";

	extern char g_pszPerformanceMenu_Title[]					= "OPTIMIZACION";
	extern char g_pszPerformanceMenu_Transparency[]			= "TRANSPARENCIA";
	extern char g_pszPerformanceMenu_3dLighting[]			= "ILUMINACION 3D";
	extern char g_pszPerformanceMenu_Particles[]				= "PARTICULAS";
	extern char g_pszPerformanceMenu_DynamicVolume[]		= "VOLUMEN DINAMICO";
	extern char g_pszPerformanceMenu_AmbientSounds[]		= "SONIDOS AMBIENTALES";

	extern char g_pszRotationSetupMenu_Title[]				= "VELOCIDADES DE GIRO ";
	extern char g_pszRotationSetupMenu_RunningSlow[]		= "CORRER (LENTO)";
	extern char g_pszRotationSetupMenu_RunningFast[]		= "CORRER (RAPIDO)";
	extern char g_pszRotationSetupMenu_StandingSlow[]		= "DE PIE (LENTO)";
	extern char g_pszRotationSetupMenu_StandingFast[]		= "DE PIE (RAPIDO)";
	extern char g_pszRotationSetupMenu_TapDegrees[]			= "GRADOS POR TOQUE";
	extern char g_pszRotationSetupMenu_RestoreDefaults[]	= "PREDETERMINADO";
	extern char g_pszRotationSetupMenu_RestoreDefaultsOld[] = "REVERTIR";

	extern char g_pszVolumesMenu_Title[]						= "MEZCLADOR DE AUDIO";

	extern char g_pszStartGameMenu_Title[]						= "INICIAR JUEGO";
	extern char g_pszStartGameMenu_SinglePlayer[]			= "UN JUGADOR";
	extern char g_pszStartGameMenu_Multiplayer[]				= "MULTIJUGADOR";
	extern char g_pszStartGameMenu_Demo[]						= "DEMO";

	extern char g_pszStartSinglePlayerMenu_Title[]			= "UN JUGADOR";
#if defined(START_MENU_ADDON_ITEM)
	#if TARGET == JAPAN_ADD_ON
		extern char g_pszStartSinglePlayerMenu_New[]			= "ENLOQUECE EN EE.UU.";
		extern char g_pszStartSinglePlayerMenu_AddOn[]		= "ENLOQUECE EN JAPON";
	#elif TARGET == POSTAL_PLUS
		extern char g_pszStartSinglePlayerMenu_New[]			= "NUEVO JUEGO (TODOS LOS NIVELES)";
		extern char g_pszStartSinglePlayerMenu_AddOn[]		= "NIVELES SPECIAL DELIVERY";
	#elif TARGET == POSTAL_2015
		extern char g_pszStartSinglePlayerMenu_NewCampaign[]	= "NUEVO JUEGO";
		...
		extern char g_pszStartSinglePlayerMenu_AllLevels[]	= "EXCESS POSTAGE (TODOS LOS NIVELES)";
	#else
		#error Strings must be customized for current TARGET
	#endif
#else
	#if TARGET == SUPER_POSTAL
		extern char g_pszStartSinglePlayerMenu_New[]			= "ENLOQUECE EN TODAS PARTES";
	#elif (TARGET == POSTAL_PLUS || TARGET == POSTAL_2015)
		extern char g_pszStartSinglePlayerMenu_New[]			= "NUEVO JUEGO";
	#else
		#error Strings must be customized for current TARGET
	#endif
#endif
	extern char g_pszStartSinglePlayerMenu_LoadLevel[]		= "SELECCIONAR NIVEL";
	extern char g_pszStartSinglePlayerMenu_LoadGame[]		= "CARGAR JUEGO";
	extern char g_pszStartSinglePlayerMenu_Challenge[]		= "DESAFIO DE LA PRUEBA";

	extern char g_pszStartChallengeMenu_Title[]				= "DESAFIO";
	extern char g_pszStartChallengeMenu_Gauntlet[]			= "LA PRUEBA";
	extern char g_pszStartChallengeMenu_Timed[]				= "CON TIEMPO";
	extern char g_pszStartChallengeMenu_Goal[]				= "OBJETIVO";
	extern char g_pszStartChallengeMenu_Flag[]				= "BANDERA";
	extern char g_pszStartChallengeMenu_CheckPoint[]		= "PUNTO DE CONTROL";

	extern char g_pszStartMultiplayerMenu_Title[]			= "MULTIJUGADOR";
	extern char g_pszStartMultiplayerMenu_Join[]				= "UNIRSE A PARTIDA";
	extern char g_pszStartMultiplayerMenu_Host[]				= "CREAR PARTIDA";
	extern char g_pszStartMultiplayerMenu_Options[]			= "OPCIONES";


	extern char g_pszJoinGameMenu_Title[]						= "UNIRSE A PARTIDA";
	extern char g_pszJoinGameMenu_Browse[]						= "BUSCAR (Solo LAN)";
	extern char g_pszJoinGameMenu_ConnectTo[]					= "CONECTAR A";

	extern char g_pszHostGameMenu_Title[]						= "CREAR PARTIDA";
	extern char g_pszHostGameMenu_Start[]						= "INICIAR";

	extern char g_pszStartDemoMenu_Title[]						= "DEMO";
	extern char g_pszStartDemoMenu_Browse[]					= "BUSCAR";
	extern char g_pszStartDemoMenu_Play[]						= "REPRODUCIR";
	extern char g_pszStartDemoMenu_Record[]					= "GRABAR";
	extern char g_pszStartDemoMenu_ConSite[]				= "CONSTRUCCION";
	extern char g_pszStartDemoMenu_Home[]					= "CASA";
	extern char g_pszStartDemoMenu_Bridge[]					= "PUENTE";

	extern char g_pszMultiplayerSetupMenu_Title[]			= "MULTIJUGADOR";
	extern char g_pszMultiplayerSetupMenu_Name[]				= "NOMBRE";
	extern char g_pszMultiplayerSetupMenu_Color[]			= "COLOR DE ABRIGO";
	extern char g_pszMultiplayerSetupMenu_Protocol[]		= "PROTOCOLO";
	extern char g_pszMultiplayerSetupMenu_Connection[]		= "CONEXION";

	// Keep at end -- was not in original localizable text.
	extern char g_pszControlsMenu_UseJoystick[]				= "USAR CONTROL";
...
extern char* g_apszScoreDisplayText[CRealm::TotalScoringModes] = 
	{
	"      Poblacion: %d                                     Hostiles: %d   Bajas %d (%d%% / %d%%)",	// Standard
	" Tiempo Restante %d:%2.2d                                Bajas: %d",				// Timed
	" Tiempo Restante %d:%2.2d                   Bajas %d               Restante %d / %d",		// TimedGoal
	" Tiempo Restante %d:%2.2d",																	// TimedFlag
	" Bajas %d                     Restante %d            Tiempo Transcurrido %d:%2.2d",// Goal
	" Tiempo Transcurrido %d:%2.2d",																		// CaptureFlag
	" Reloj %d:%2.2d    Tienes %d banderas    Banderas Restantes %d",						// Checkpoint
	"Tiempo Restante %d:%2.2d",																		// MPTimed
	"Tiempo Restante %d:%2.2d",																		// MPFrag
	"",																									// MPLastMan,
	"",																									// MPCaptureFlag
	"",																									// MPTimedFlag,
	"",																									// MPTimedFrag
...
extern char* g_apszScoreGoalText[CRealm::TotalScoringModes] = 
	{
	"      Debes eliminar al %d%% de los hostiles.",												// Standard
	" Consigue tantas bajas como sea posible en el tiempo restante.",							// Timed
	" Elimina a todos antes de que se acabe el tiempo.",													// TimedGoal
	" Captura la bandera antes de que se acabe el tiempo.",												// TimedFlag
	" Elimina a %d personas en el menor tiempo posible.",										// Goal
	" Captura la bandera en el menor tiempo posible.",									// CaptureFlag
	" Consigue tantas banderas como puedas antes de que se acabe el tiempo.",								// Checkpoint
	" El jugador con mas bajas cuando expire el tiempo es el ganador",				// MPTimed
	" El primer jugador en conseguir %d bajas gana",													// MPFrag
	"",																									// MPLastMan,
	"",																									// MPCaptureFlag
	"",																									// MPTimedFlag
	" Intenta alcanzar %d bajas antes de que expire el tiempo",											// MPTimedFrag
	"",																									// MPLastManFrag
	"",																									// MPLastManTimed
	" No hay limite de tiempo ni de bajas en esta partida - juega todo lo que quieras"	// MPLastManTimedFrag 
...
extern char* g_apszScoreUnits[]	=
		...
		"",				// Capture the flag.
		"Banderas",			// Checkpoint.
		"Bajas",			// Multiplayer timed.
		"Bajas",			// Multiplayer Frag limited.
		"Bajas",			// Multiplayer last man standing.
		"Bajas",			// Multiplayer capture the flag.
		"Bajas",			// Multiplayer Timed capture the flag.
		"Bajas",			// Multiplayer timed frags.
		"Bajas",			// Multiplayer last man frag limited.
		"Bajas",			// Multiplayer last man with time limit.
		"Bajas",			// Multiplayer last man frag and time limited.
		};
...
extern char* g_apszScoreExplanations[]	=
		{
		"",												// Standard.
		"Mayor cantidad de bajas en %s",							// Timed.
		"Mejores tiempos al eliminar %d hostiles",	// Timed goal.
		"Mejores tiempos al capturar la bandera",	// Timed flag.
		"Mejores tiempos al eliminar %d hostiles",	// Goal.
		"Mejores tiempos al capturar la bandera",	// Capture the flag.
		"Mayor cantidad de banderas recolectadas",						// Checkpoint.
		"Top %d Puntuaciones",								// Multiplayer timed.
		"Top %d Puntuaciones",								// Multiplayer frag.
		"Top %d Puntuaciones",								// Multiplayer last man standing.
		"Top %d Puntuaciones",								// Multiplayer capture the flag.
		"Top %d Puntuaciones",								// Multiplayer Timed capture the flag.
		"Top %d Puntuaciones",								// Multiplayer timed frags.
		"Top %d Puntuaciones",								// Multiplayer last man frag limited.
		"Top %d Puntuaciones",								// Multiplayer last man with time limit.
		"Top %d Puntuaciones",								// Multiplayer last man frag and time limited.
		};
