...
CInputSettings::InputInfo	CInputSettings::ms_ainputinfo[CInputSettings::NumInputFunctions]	=
	{	// Description			Save Name			Default Key			Default Mouse Button(s)			Default Joy Button(s)
		//	===========			===========			===========			=======================			=====================
		{	"Girar Izquierda",	"Left",				0,					0,										0,								},
		{	"Girar Derecha",	"Right",			0,					0,										0,								},
		{	"Adelante",			"Forward",			0,					0,										0,								},
		{	"Atras",			"Backward",			0,					0,										0,								},
		{	"Arriba",			"Up",				RSP_SK_W,			0,										0,	                            },
		{	"Abajo",			"Down",				RSP_SK_S,			0,										0,								},
		{	"Izquierda",		"MoveLeft",			RSP_SK_A,			0,										0,								},
		{	"Derecha",			"MoveRight",		RSP_SK_D,			0,										0,								},
		{	"Paso Izq", 		"StrafeLeft",		0,					0,										0,								},
		{	"Paso Der", 		"StrafeRight",		0,					0,										0,								},
		{	"Correr",			"Run1",				RSP_SK_SHIFT,		0,										0,						        },
		{	"Correr",			"Run2",				0,					0,										0,								},
		{	"Mov. Lateral", 	"Strafe1",			0,					0,										0,						        },
		{	"Mov. Lateral", 	"Strafe2",			0,					0,										0,								},
		{	"Disparo Princ",	"Fire",				RSP_SK_CONTROL,		0,										RSP_JOY_BUT_17,					},
		{	"Disparo Secun",	"Fire2",			0,					0,										0,								},
		{	"Disparo Izq",  	"FireLeft",			RSP_SK_LEFT,		0,										0,								},
		{	"Disparo Der",  	"FireRight",		RSP_SK_RIGHT,		0,										0,								},
		{	"Disparo Arriba",	"FireUp",			RSP_SK_UP,			0,										0,								},
		{	"Disparo Abajo",	"FireDown",			RSP_SK_DOWN,		0,										0,								},
		{	"Agacharse",		"Duck",				RSP_SK_F,			0,										RSP_JOY_BUT_16,					},
		{	"Revivir",			"Rejuvenate",		RSP_SK_SPACE,		0,										RSP_JOY_BUT_1,					},
		{	"Ejecutar",			"Execute",			RSP_SK_X,			0,										RSP_JOY_BUT_3,					},
		{	"Suicidarse",		"Suicide",			RSP_SK_K,			0,										RSP_JOY_BUT_4,					},
		{	"Sig. Nivel",		"NextLevel",		RSP_SK_F1,			0,										RSP_JOY_BUT_2,					},
		{	"Sig. Arma",		"NextWeapon",		RSP_SK_RBRACKET,	0,										RSP_JOY_BUT_11,					},
		{	"Arma Ant.",		"PrevWeapon",		RSP_SK_LBRACKET,	0,										RSP_JOY_BUT_10,					},
		{	"Sin Arma",			"NoWeapon",			RSP_SK_LQUOTE,		0,										0,								},
		{	"Subfusil", 		"MachineGun",		RSP_SK_1,			0,										0,								},
		{	"Escopeta",			"Shotgun",			RSP_SK_2,			0,										0,								},
		{	"Escopeta Aut.",	"SprayCannon",		RSP_SK_3,			0,										0,								},
		{	"Granadas",			"Grenades",			RSP_SK_4,			0,										0,								},
		{	"Bazooka",  		"Missiles",			RSP_SK_5,			0,										0,								},
		{	"Misil guiado",		"Heatseekers",		RSP_SK_6,			0,										0,								},
		{	"Molotov",			"Molotovs",			RSP_SK_7,			0,										0,								},
		{	"Napalm",			"Napalm",			RSP_SK_8,			0,										0,								},
		{	"Lanzallamas",		"Flamer",			RSP_SK_9,			0,										0,								},
		{	"Minas",			"Mines",			RSP_SK_0,			0,										0,								},
	};
